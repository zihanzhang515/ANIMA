 ...
 *   - Servos and LED powered by external 5V 6A supply
 *   - IMPORTANT: External GND must connect to Arduino GND (common ground)
 *   - Remove blue jumper cap on Sensor Shield to use external power
 *
